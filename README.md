...
If you use the -screenbin.bin firmware, you can use the screenshot binary with [Joel's handy tool](https://github.com/jcalado/radshot). Note that taking screenshots will affect the radio's performance and may lead to eventually hangs or weird behaviours.
