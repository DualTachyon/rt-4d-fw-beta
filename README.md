...
- **"fe8769"** : "I'm smarter than you and won't try your suggestion" and blackmailing with fake threats of law enforcement.
- **"Nobody@TG"** : Insulting everyone's intelligence by saying a solution doesn't work and blaming it on the English language.
- **John Telek** : Facebook keyboard warrior that prefers to complain about firmware instead of reporting bugs.
...
**No release until Radtel releases DMR FW 1.2.0.28 or newer**
...
- Beta 41
  ...
  - Talker Alias is now supported:
    ...
    - You can also toggle Talker Alias on and off with the * key during a DMR call, but this change is not automatically saved. It gets saved the next tiime any other setting is saved.
  ...
  - When DMR firmware produces invalid IDs, errors will now display on screen.
    - This is the new UX for the old ID=275 problem.
    - If you have Talker Alias enabled, you will be able to see who's calling if the data is available.
